...
while (continuar) {
    ...
    if (passGuardado === passUsuario) {
        alert("Bienvenido/a");
        continuar = false; 
        //En este caso particular, al usar la sentencia break podemos obviar esta línea, pero recuerden que siempre tiene que haber alguna condición de salida para no generar un bucle infinito
        break;
    }
