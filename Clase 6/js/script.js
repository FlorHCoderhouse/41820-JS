...
/* //Método split de los strings. epara un string usando como divisor el caracter que le pasemos por parámetro. Básicamente, va a agarrar el string, y buscar el caracter, cada vez que lo encuentre en el string, corta ese pedacito y lo guarda como un elemento independiente en un array. El caracter no lo guarda. Por ejemplo:
let cadenaConArrobas = 'Hola@soy@un@string@con@muchos@arrobas'
let arrayDesdeCadena = cadenaConArrobas.split('@')
console.log(arrayDesdeCadena);

//Otro ejemplo, diciendo que separe todo. Para eso, al split le paso una cadena vacía como parámetro. Entonces va a separar letra por letra:
let separado = familiaSimpson[2].split('');
